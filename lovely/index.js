...
(async () => {
    ...
    const filename = 'lovely-fun-product.json';
    ...
    // Stock toutes les infos des buttons
    ...
    for (const productLink of productLinks) {
        ...
        //reference
        let reference;
        await productPage.waitForSelector(selectReference, {timeout: 100000}).then(async () => {
        ...
        // EAN
        let EAN;
        await productPage.waitForSelector(selectEAN, {timeout: 1000000}).then(async () => {
