...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/love-to-love-cosmeto.html');
    console.log('go on ltl cosmetique products pages')
    ...
    const filename = 'ltl_cosmetique-product.json';
