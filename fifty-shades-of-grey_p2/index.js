...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/fifty-shades-of-grey.html?p=2');
    console.log('go on fifty shades of grey products pages')
    ...
    const filename = 'fifty-shades-of-grey-p2-product.json';
