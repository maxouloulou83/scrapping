...
(async () => {
    ...
    const mainUrl = 'https://en.funfactory.com/collections/cock-rings';
    ...
    const filename = 'fun-cock-rings-product.json';

    // Attendre que le selector des liquides charge
    await page.waitForSelector('#CollectionAjaxResult > div > div > div > div > a', {timeout: 100000});

    // Stock toutes les infos des buttons vers les collections
    const products = await page.$$('#CollectionAjaxResult > div > div > div > div > a');
