...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/rosebuds.html');
    console.log('go on rosebud products pages')
    ...
    const filename = 'rosebud-product.json';
