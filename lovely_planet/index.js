...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/love-to-love-gifts.html');
    console.log('go on lovely planet products pages')
    ...
    const filename = 'lovely-planet-product.json';
