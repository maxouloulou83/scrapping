...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/big-teaze-toys.html');
    console.log('go on big teaze toys on me products pages')
    ...
    const filename = 'big-teaze-toys-product.json';
