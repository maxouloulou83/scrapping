...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/love-to-love.html?p=3');
    console.log('go on love to love products pages')
    ...
    const filename = 'love-to-love-p3-product.json';
