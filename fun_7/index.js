...
(async () => {
    ...
    const mainUrl = 'https://en.funfactory.com/collections/kegel-balls';
    ...
    const filename = 'fun-kegel-balls-product.json';

    // Attendre que le selector des liquides charge
    await page.waitForSelector('.grid-product__content', {timeout: 100000});

    // Stock toutes les infos des buttons vers les collections
    const products = await page.$$('#CollectionAjaxResult > div > div > div');
