...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/strap-on-me.html?p=3');
    console.log('go on strap on me products pages')
    ...
    const filename = 'strap-on-me-p3-product.json';
