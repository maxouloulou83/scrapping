...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/tease-and-please.html');
    console.log('go on tease & please products pages')
    ...
    const filename = 'tease-please-product.json';
