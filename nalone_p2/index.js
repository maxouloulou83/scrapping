...
(async () => {
    ...
    await page.goto('https://www.lovely-planet-distribution.com/fra/docutheque/nalone.html?p=2');
    console.log('go on nalone products pages')
    ...
    const filename = 'nalone-p2-product.json';
